...
either *flow* to a fixed point or go to $\pm \infty$.

What is interesting about the study of such problems? Identifying when the structure of solutions (i.e. when the number and/or stability of fixed points changes at particular parameter values). Such points are known as bifurcation points.

At a bifurcation point of a 1D system the eigenvalue is 0. the fixed point is *not* hyperbolic.
