...
$$
where $\mathbf{x}=(x,y)^T$ and $\mathbf{f}=(f_1,f_2)^T$.
...
\frac{d\hat{v}}{dt}&=g(x^*+\hat{x},y^*+\hat{y}).
\end{aligned}
...
$$
\begin{aligned}
\frac{d\hat{x}}{dt}=\frac{\partial f}{\partial x}_{|(x^*,y^*)} \hat{x} +  \frac{\partial f}{\partial y}_{|(x^*,y^*)}  \hat{v} + h.o.t, \nonumber\\
\frac{d\hat{v}}{dt}=\frac{\partial g}{\partial x}_{|(x^*,y^*)}  \hat{x} +  \frac{\partial g}{\partial y}_{|(x^*,y^*)}  \hat{v} + h.o.t. \nonumber
\end{aligned}
