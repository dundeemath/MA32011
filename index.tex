...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, opacityback=0, titlerule=0mm, toprule=.15mm, colback=white, colframe=quarto-callout-note-color-frame, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, bottomrule=.15mm, breakable, bottomtitle=1mm, toptitle=1mm, rightrule=.15mm, left=2mm, coltitle=black]
...
\ddot{x}=-\mu x,
\] \{eq-secondorderODE\} where \(\mu=-k/m\).
